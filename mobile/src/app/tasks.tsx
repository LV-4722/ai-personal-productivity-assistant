...
export default function TasksScreen() {
  ...
  const isRemindersOnly = filter === 'reminders';
  ...
  const displayedTasks = isRemindersOnly
    ? tasks.filter((t) => t.due_date !== null && t.due_date !== undefined)
    : tasks;
      ...
      <SafeAreaView edges={['top', 'left', 'right']} style={styles.safeArea}>
        <View style={styles.topNavigationHeader}>
          <Pressable onPress={() => router.back()} style={styles.backButton}>
            <ThemedView type="backgroundSelected" style={styles.backButtonContent}>
        ...
        <View style={styles.header}>
          <View style={{ flex: 1 }}>
            <ThemedText type="subtitle">
              {isRemindersOnly ? 'Reminders & Due Tasks' : 'Tasks'}
            </ThemedText>
            <ThemedText type="small" themeColor="textSecondary">
              {isRemindersOnly
                ? 'Tasks with scheduled due dates'
        ...
        {isLoading ? (
          <View style={styles.centeredState}>
            ...
            <ThemedText themeColor="textSecondary">Loading tasks…</ThemedText>
          </View>
        ) : showInitialError ? (
          <View style={styles.centeredState}>
          ...
          <FlatList
            ...
            contentContainerStyle={[
              styles.listContent,
              displayedTasks.length === 0 && styles.emptyListContent,
            ]}
            ListHeaderComponent={
            ...
            ListEmptyComponent={
              <View style={styles.centeredState}>
                <ThemedText>
                  {isRemindersOnly ? 'No reminders with due dates.' : 'No tasks yet.'}
                </ThemedText>
                <ThemedText type="small" themeColor="textSecondary">
                  {isRemindersOnly
